                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="no_of_compartment" />
                                     ...
                                     <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="recommended_age" />
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="backpack_style" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="bag_capacity" />
                                                </div>
                                            </div>
