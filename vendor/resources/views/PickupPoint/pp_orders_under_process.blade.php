...
<head>
    ...
    <title> Pickup Point Orders Under Process</title>
            ...
            <div class="layout-page">
                ...
                <div class="container mt-3">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                          <h5 class="card-header">View Pickup Point Order  Under Process </h5>
                        <div class="row">
                         <div class="col-md-5">
...
function get_pp_orders()
{
    let pickup_point_select=document.getElementById('pickup_point_select').value;
     setTimeout(function()
     {
      window.location.href="{{url('/') }}/pp_order_under_process_pp/"+pickup_point_select;
     }, 2000);
}
