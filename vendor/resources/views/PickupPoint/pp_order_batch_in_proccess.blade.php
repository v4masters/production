...
<head>
    ...
    <title>Pickup Point Batch Orders Under Proccess</title>
                ...
                <div class="container mt-3">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            ...
                            <div class="card">
                                <h5 class="card-header">Pickup Point  Order  Under Process</h5>
                                                  ...
                                                  <!--<td></td>-->
                                                   <td> @if($data->print_status==1)<span class="bg-success text-white p-1">{{'Printed';}}</span> @else <span class="bg-danger text-white p-1">{{'Unprint';}}</span>@endif <br>{{$data->created_at}}</td>
                                                    <td>{{$data->comment}} </td>
                                                     ...
                                                     <td><a  href="{{url('pp_bacth_all_order',[$data->id, $data->batch_id])}}" class="btn btn-primary">View all</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
