            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Form -->
                        <form action="{{ url('/') }}/forgot_password_sendOtp" method="POST" class="user">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name="phone_no" placeholder="Enter Phone" autofocus required />
                            </div>
