...
<head>
    ...
    <title>Set Item Sale Report</title>
...
<body>
                ...
                <div class="container mt-3">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="container">
                      <h5 class="card-header">Set Item Sale Report</h5>
                        ...
                        <div class="container">
                            ...
                            <div class="card">
                                    ...
                                    <form method="GET" action="{{ url('/set_item_sale_report') }}" class="row g-3 mb-4">
    <div class="col-md-4">
    ...
    <div class="col-md-4 align-self-end">
        ...
        <a href="{{ url('/set_item_sale_report') }}" class="btn btn-secondary">Reset</a>
    </div>
</form>
                                ...
                                <div class="table-responsive text-nowrap">
                                    ...
                                    <table class="table table-striped" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-fullscreen="false" data-show-columns="true" data-show-columns-toggle-all="true" data-detail-view="false" data-show-export="true" data-click-to-select="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, 500, 1000 ,all]" data-show-footer="true" data-response-handler="responseHandler">
                                       ...
                                       <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-sortable="true" data-visible="true">Itemcode</th>
                                                <th data-sortable="true" data-visible="false" >Barcode</th>
                                                <th data-sortable="true">Class</th>
                                                <th data-sortable="true">Company</th>
                                                <th data-sortable="true">Hsncode</th>
                                                <th data-sortable="true">Itemname</th>
                                                <th data-sortable="true"> Sale </th>

                                            </tr>
                                        </thead>
                                        <tbody>
                                              @foreach($item_sale as $key => $data)
                                              <tr >
                                                <td >{{$key+1}}</td>
                                                <td >{{$data->itemcode}}</td>
                                                <td >{{$data->barcode}}</td>
