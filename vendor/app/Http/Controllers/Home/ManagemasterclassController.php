...
public function inventory_mensfashion(string $id)
 ...
 //get_size_list
    ...
    //         $image = date('YmdHis')."-".rand() . '.' . $request->file('unit_chart')->getClientOriginalExtension();

    //         $path = base_path() . '/public/uploads/unitchart/';

    //         $request->file('unit_chart')->move($path, $image);
    //     } else {
    ...
    //         $image = date('YmdHis')."-".rand() . '.' . $request->file('brand_logo')->getClientOriginalExtension();

    //         $path = base_path() . '/public/uploads/brand_logo/';

    //         $request->file('brand_logo')->move($path, $image);
    //     } else {
    ...
    //         $image =  date('YmdHis')."-".rand(). '.' . $request->file('brandlogo')->getClientOriginalExtension();

    //         $path = base_path() . '/public/uploads/brand_logo/';

    //         $request->file('brandlogo')->move($path, $image);
    ...
    //         $image =  date('YmdHis')."-".rand() . '.' . $request->file('chart')->getClientOriginalExtension();

    //         $path = base_path() . '/public/uploads/sizechart/';

    //         $request->file('chart')->move($path, $image);
    //     } else {
    ...
    //     $data['pagedata'] = InventoryformsModel::where('id', $id)->first();
    //     $data['route'] = MasterformrouteModel::orderBy('id', 'DESC')->where('del_status', 0)->get();
    ...
    //     $data['qty'] = managemasterqtyModel::orderBy('id', 'DESC')->where('del_status', 0)->get();
    //     $data['brand'] = managemasterbrandModel::orderBy('id', 'DESC')->where('del_status', 0)->get();
    //     $data['colour'] = managemastercolourModel::orderBy('id', 'DESC')->where('del_status', 0)->get();
    //     $data['stream'] = managemasterstreamModel::orderBy('id', 'DESC')->where('del_status', 0)->get();
       
    //     return view('inventory_form_edit',$data);
    // }
