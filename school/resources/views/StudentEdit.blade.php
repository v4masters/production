                ...
                <div class="container mt-3">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formAuthentication" class="mb-3" action="{{url('/') }}/editStudent" method="POST">
                                ...
                                <input type="hidden" name="id" class="form-control" value="{{ $pagedata->unique_id }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="fathers_name" value="{{ $pagedata->fathers_name }}" />
