                            ...
                            data-response-handler="responseHandler">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$data->phone_no}}</td>
                                        <td>{{$data->classno}}</td>
                                        <td>{{$data->address}}, <br> {{$data->pincode}}</td>
                                       ...
                                       <!-- <td>
                                            <button type="button" class="mb-3 btn btn-primary btn-sm" >View</button>
                                            <br>
                                            <a href="{{url('/')}}/editStudentView/{{$data->unique_id}}" class="mb-3 btn btn-success btn-sm">Edit</a>
                                            <br>
                                        </td> -->
                                    </tr>
                                    @endforeach
