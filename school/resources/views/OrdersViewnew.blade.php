                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="w-20">
                                    <form method="GET" action="{{ route('ordersview') }}" class="row g-3 mb-3" id="filterForm">
                                        @csrf
                                        <div class="col-md-2">
                                            <select name="order_status" class="form-select">
                                                <option value="">-- Select Status --</option>
                                                <option value="1" {{ request('order_status') == 1 ? 'selected' : '' }}>Pending</option>
                                                <option value="2" {{ request('order_status') == 2 ? 'selected' : '' }}>Placed</option>
                                                <option value="3" {{ request('order_status') == 3 ? 'selected' : '' }}>In Progress</option>
                                                <option value="4" {{ request('order_status') == 4 ? 'selected' : '' }}>Delivered</option>
                                                <option value="5" {{ request('order_status') == 5 ? 'selected' : '' }}>Cancelled</option>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <tr>
                                              ...
                                              <td>{{ $data->classno}}</td>
                                                ...
                                                <td>{{$data->order_time}}</td>
                                                  <td>
                                                 <strong>Tracking:</strong> {{ $data->courier_number ?? 'N/A' }}<br>
                                                 <strong>Delivered on:</strong> {{ \Carbon\Carbon::parse($data->updated_at)->format('d-m-Y H:i') }}
                                                 </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('order.detail', ['id' => $data->invoice_number]) }}">View Order</a>
