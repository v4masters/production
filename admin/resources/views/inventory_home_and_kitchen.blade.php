...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no minimum-scale=1.0, maximum-scale=1.0" />
      ...
      <title>Home And Kitchen Inventory</title>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="add_ons" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="body_material" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="burner_material" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="no_of_burners" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="packaging_breadth" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="packaging_height" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="packaging_length" />
