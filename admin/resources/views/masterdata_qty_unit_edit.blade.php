...
<head>
  ...
  <title>Edit Master Quantity Unit</title>
        ...
        <div class="container mt-3">
          ...
          <div class="card mb-4">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <h5 class="mb-0">Edit Quantity Unit</h5>
            ...
            <div class="card-body">
              ...
              <div class="row d-flex justify-content-start">
                  ...
                  <form id="formAuthentication" class="mb-3" action="{{url('/') }}/editqtyunit" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group mb-3">
                          ...
                          <label class="form-label" for="basic-icon-default-fullname">Quantity Unit:</label>
