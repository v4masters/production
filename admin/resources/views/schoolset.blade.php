            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home / Manage Set / </span> Create-Edit Set</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="submitform" class="p-5 mb-3" action="{{url('/') }}/add_school_set" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="card mt-2 mb-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select class="form-select" onchange="selected_school(this.value)"  name="grade" id="form-select-md-grade" data-placeholder="Select" required>
                                             ...
                                             <div class="list_wrapper mt-5">
                                                ...
                                                <div class="row">
                                                        <!--<div class="col-sm-1"><div class="form-group mb-2"><label class="slno"><b><i class="menu-icon tf-icons bx bx-circle"></i></b></label></div></div>-->
                                                   
                                                    <div class="col-sm-6">

                                                        <div class="form-group mb-3">

                                                            <input type="text"  onkeydown="getitemlist(this.id)" class="form-control itemname"  id='itemname_0' placeholder="Itemname" required>
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="number" class="form-control" value="1" min="1" placeholder="Item Qty" id='qty_0' name="item_qty[]" required >
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group mb-3">
                                                              ...
                                                              <input type="text" class="form-control" placeholder="Price" id='unitprice_0'  readonly required>
                                                              <input type='hidden' name="itemid[]" class='form-control' id='itemid_0' readonly required>
...
// 			alert(response.alertmsg)
				$.toast({ heading:  response.success_msg, position: 'top-right',stack: false,icon: 'success'})
                    ...
                    document.getElementById('itemname_0').value="";
                    document.getElementById('qty_0').value=1;
                    document.getElementById('unitprice_0').value="";
                    document.getElementById('itemid_0').value="";
                    x = 0;
                    
                  
                    $('#alertmsg').append(response.alertmsg); 
...
$('#school_select').selectpicker();
            ...
            $(document).ready(function() {
                var list_maxField = 40; //Input fields increment limitation
