...
<div class="layout-wrapper layout-content-navbar">
            ...
            <div class="container mt-3">
                <div class="card mb-4">
                    ...
                    <div class="container">
                        ...
                        <form method="GET" action="{{ route('orders.order_processing_online') }}"
    ...
    <tr>
        ...
        <td>{!! $row->tracking_status_html !!}<br>
...
/* $(document).on('click', '.mark-delivered-btn', function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            location.reload();
             // Reload to remove it from the list
        },
        error: function () {
...
/*$(document).ready(function () {
    $(document).on('click', '.mark-delivered-btn', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                alert(response.message || 'Order marked as delivered.');

                // Immediately and permanently remove the row
                row.remove();
            },
            error: function (xhr) {
