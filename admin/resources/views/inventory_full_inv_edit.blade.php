...
<body>
                ...
                <div class="container mt-3">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formAuthentication" class="mb-3" action="{{url('/') }}/editfullinventory" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="list_wrapper">
                                   ...
                                   Active Banner Image
                                    ...
                                    <input class="btn btn-primary form-control mt-1" type="button"  onclick="dp_status_changed(`{{$images->id}}`,`{{$images->vendor_id}}`,`{{$images->item_id}}`)"  value="Set as Main Banner" >
                                    @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="laptop_capacity"  value="{{ $pagedata->laptop_capacity}}"/>
  ...
  function removeinvimge(id)
   ...
   //dp_status_changed
   function dp_status_changed(image_id,vendor_id,item_id)
   {
          $(".loader").css("display","block");
                $.ajax({
                type: "POST",
                url: "{{url('/') }}/updatedpstatus",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "image_id": image_id,
                    "vendor_id": vendor_id,
