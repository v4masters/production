...
<head>
  ...
  <title>Edit Master Grade Details</title>
            ...
            <div class="card-body">
              ...
              <div class="row d-flex justify-content-start">
                ...
                <div class="col-md-6">
                  ...
                  <form id="formAuthentication" class="mb-3" action="{{url('/') }}/editmastergrade" method="POST">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group mb-3">
                          ...
                          <label class="form-label" for="basic-icon-default-fullname">Grade Name:</label>
