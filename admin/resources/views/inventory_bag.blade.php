                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="laptop_capacity" required />
                                                    <!--<select class="form-select" name="laptop_capacity" required>-->
                                                    <!--    <option disabled selected hidden>select</option>-->
                                                    <!--    <option value="Upto 13 Inch">Upto 13 Inch</option>-->
                                                    <!--    <option value="Upto 14 Inch">Upto 14 Inch</option>-->
                                                    <!--    <option value="Upto 15 Inch">Upto 15 Inch</option>-->
                                                    <!--    <option value="Upto 16 Inch">Upto 16 Inch</option>-->
                                                    <!--    <option value="Upto 17 Inch">Upto 17 Inch</option>-->
                                                    <!--    <option value="Upto 18 Inch">Upto 18 Inch</option>-->
                                                    <!--</select>-->
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <!--    <option value="Faux Leather/Le">Faux Leather/Le</option>-->
                                                    ...
                                                    <!--    <option value="Not Presen">Not Present</option>-->
                                                    <!--</select>-->
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <!--    <option value="Laptop Roller Cases">Laptop Roller Cases</option>-->
                                          ...
                                          <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="defaultSelect" class="form-select" name="water_resistant">
                                                        <option disabled selected hidden>select</option>
