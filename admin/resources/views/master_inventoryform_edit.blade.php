...
<head>
  ...
  <title>Edit Inventory Form Details</title>
        ...
        <div class="container mt-3">
          ...
          <div class="card mb-4">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <h5 class="mb-0">Edit Inventory Form</h5>
            ...
            <div class="card-body">
              ...
              <div class="row d-flex justify-content-start">
                ...
                <div class="col-md-6">
                  ...
                  <form id="formAuthentication" class="mb-3" action="{{url('/') }}/editmasterinventoryform" method="POST">
                    ...
                    <div class="row">
                      <div class="col-sm-5">
                        <div class="form-group mb-3">
                          ...
                          <label class="form-label" for="basic-icon-default-fullname">Form Name:</label>
