...
<body>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" id="myform" action="{{url('/') }}/add_inventory" enctype="multipart/form-data" novalidate>
                                        ...
                                        <input type="hidden" class="form-control" value="1" name="cat_type" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="defaultSelect" class="form-select" name="book_format" >
                                                       <option selected disabled value="">Select</option>
                                                        <option value="Audible Audio Edition"> Audible Audio Edition</option>
                                            ...
                                            <!-- <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="form-select-md" data-placeholder="&#xF4FA; ADD SERVICE">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number"   onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" name="publish_year" />
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                 ...
                                                 <div class="input-group">
                                                    ...
                                                    <select class="form-select" id="form-select-md-brand" data-placeholder="Select" name="brand" required>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="form-select-md-stream" data-placeholder="Select" name="stream" >
                                                       <option selected disabled value="">Select</option>
                                                        <option value="0">N/A </option>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control phone-mask" name="printer_details" />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="radio" class="form-check-input ms-3" onchange="show_size_list({{$size_listdata->id}})" name="size" value="{{$size_listdata->id}}" required>
    ...
    <!-- //min qty pop up -->
    <!--<div class="modal" id="show_minqty_modal">-->
    <!--    <div class="modal-dialog modal-sm">-->
    <!--        <div class="modal-content">-->
    <!--            <div class="modal-header bg-primary text-white text-center">-->
    <!--                <h3 class=" text-white">Minimum Quantity</h3>-->
    <!--            </div>-->

    <!--            <div class="modal-body">-->
    <!--                <p>Please Enter the minimum quantity offering to this inventory for sale <br>Like 1,3 10/100 etc </p>-->
    <!--            </div>-->
    <!--            <div class="modal-footer">-->
...
let checkrow=0;
let checkrowname=0;
function add_mul_color_qty(imgrow,currow,rowid,imgnameid,myImgModal,totalrow,rowclass,classtitle,clr_qty,clr_min_qyt,clr_qty_unit,clr_hsncode,clr_barcode,clr_isbn,clr_netweight,clr_mrp,clr_discount,clr_discounted_price,clr_sales_price,clr_gst,clr_shipping_charges,clr_edition,clr_book_pdf)
{
