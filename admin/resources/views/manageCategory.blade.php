  ...
  @include('includes.header_script')
   ...
   <style>
        .imagePreview {
            ...
            background: url(https://evyapari-new.s3.ap-south-1.amazonaws.com/default.jpg);
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form action="{{url('/') }}/manageCategory" method="POST" enctype="multipart/form-data">
                  @csrf
                  @if ($errors->any())
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group mb-3">
                        <label class="form-label">Market Fee<span class="required">*</span></label>
                        <input type="number" class="form-control" name="market_fee" required />
                      </div>
                    </div>
                  </div>
              ...
              <div class="card-body">
                  ...
                  <div class="list_wrapper">
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="form-group mb-3">
                          <label class="form-label">Sub Category Icon<span class=""></span></label>
                          <input type="file" class="form-control" name="sub_img[]" value="" >

                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-group mb-3">
                          <label  class="form-label">Sub Category <span class="">*</span></label>
                          <input type="text" class="form-control"  name="sub_name[]" value="" >
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-group mb-3">
                          <label  class="form-label">Sub Description<span class=""></span></label>
                          <input type="text" class="form-control" id="disablecopypast" name="sub_des[]" value="" >
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="form-group mb-3">
                          <label class="form-label">Sub Market Fee<span class="">*</span></label>
                          <input type="number" class="form-control" name="sub_market_fee[]" value="" >
                        </div>
                      </div>
