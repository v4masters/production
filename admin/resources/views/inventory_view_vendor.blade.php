...
<head>
    ...
    <title> Vendor Pending Inventory</title>
...
<body>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            ...
                            <div class="card">
                                ...
                                <h5 class="card-header"> Vendor Pending Inventory </h5>
                                    ...
                                    <table class="table table-striped" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-fullscreen="false" data-show-columns="true" data-show-columns-toggle-all="true" data-detail-view="false" data-show-export="true" data-click-to-select="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, 500, 1000 ,all]" data-show-footer="true" data-response-handler="responseHandler">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$data->vendor_info->unique_id}} <br> {{$data->vendor_info->username}} <br> {{$data->vendor_info->email}} </td>
                                                ...
                                                <a href="{{url('inventory_vendor_approve',$data->id)}}" class="btn btn-primary btn-sm ">Approve</i></a>
                                                <a href="{{url('inventory_vendor_reject',$data->id)}}" class="btn btn-primary btn-sm ">Reject</i></a></td>

                                                <td>
                                                    <ul class="list-inline">
                                                        
                                                         <li class="list-inline-item"><a href="{{url('vendor_inventory_detail',$data->id)}}" class="btn btn-primary btn-sm "><i class="bi bi-eye-fill " title="View"></i></a></li>
                                                        <li class="list-inline-item"> <a href="{{url('editfullinventory',$data->id)}}" class="btn btn-primary btn-sm"><i class=" bx bx-pencil"></i></a> </li>
                                                        <li class="list-inline-item">
                                                            <form class="mb-3" action="{{url('/') }}/deleteinventory" method="POST" type="button" onsubmit="return confirm('This Inventory will be delete')">
    ...
    <script>
        function update_sale_rate(id, sale_rate_id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('/') }}/update_vendor_sale_rate",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id,
                    "sale_rate": sale_rate
        ...
        function update_net_quantity(id, net_quantity_id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('/') }}/update_vendor_net_quantity",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id,
