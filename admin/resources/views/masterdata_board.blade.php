...
<head>
  ...
  <title>Manage Master Board</title>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              ...
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <h5 class="mb-0">Add Master Board</h5>
              ...
              <div class="card-body">
                ...
                <form action="{{url('/') }}/manageboard" method="POST" enctype="multipart/form-data">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><a href="{{url('editmasterboard',$data->id)}}" class="btn btn-primary btn-sm"><i class=" bx bx-pencil"></i></a></li>
                        <li class="list-inline-item">
                            
                          <form class="mb-3" action="{{url('/') }}/deleteboard" method="POST" type="button" onsubmit="return confirm('This Board will be delete')">
