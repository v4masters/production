...
<head>
  ...
  <title>Manage Master School Grade</title>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card mb-4">
              ...
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <h5 class="mb-0">Add Master School Grade</h5>
              ...
              <div class="card-body">
                ...
                <form action="{{url('/') }}/managegrade" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="form-group mb-3">
                      ...
                      <label class="form-label">Grade Name: <span class="required">*</span></label>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><a href="{{url('editmastergrade',$data->id)}}" class="btn btn-primary btn-sm"><i class=" bx bx-pencil"></i></a></li>
                        <li class="list-inline-item">
                            
                          <form class="mb-3" action="{{url('/') }}/deletegrade" method="POST" type="button" onsubmit="return confirm('This Grade will be delete')">
