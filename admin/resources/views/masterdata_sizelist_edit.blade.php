...
<head>
  ...
  <title>Edit Master Class Details</title>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <h5 class="mb-0">Edit Size List Details</h5>
     ...
     <!-- <small class="text-muted float-end">Add Access Data</small> -->
        ...
        <div class="card-body">
          ...
          <div class="row d-flex justify-content-start">
            ...
            <form id="formAuthentication" class="mb-3"  action="{{url('/') }}/editmastersizelist"  method="POST"> 
           ...
           <div class="alert alert-danger">
            ...
            <input type="hidden" name="size_id" class="form-control"  value="{{ $pagedata->size_id }}" required />
